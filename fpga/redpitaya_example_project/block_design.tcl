...
# module references:
# mux_2x1, red_pitaya_adc, mux_8x2, red_pitaya_dac, coarse_gain_and_limiter, coarse_gain_and_limiter, conditional_adder_8x2, coarse_gain_and_limiter, fine_gain, GPIO_mux, GPIO_mux, GPIO_mux, GPIO_mux, GPIO_super_mux
...
proc create_hier_cell_multi_GPIO_0 { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 3 -to 0 data0_o1
  create_bd_pin -dir O -from 2 -to 0 data1_o
  create_bd_pin -dir O -from 2 -to 0 data2_o
  create_bd_pin -dir O -from 7 -to 0 data3_o
  create_bd_pin -dir O -from 7 -to 0 data4_o
  create_bd_pin -dir O -from 1 -to 0 data5_o
  create_bd_pin -dir O -from 1 -to 0 data6_o
  ...
  if { [catch {set GPIO_mux_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
   ...
   CONFIG.DATA_WIDTH_5 {2} \
   CONFIG.DATA_WIDTH_6 {2} \
...
# Hierarchical cell: gain_block
proc create_hier_cell_gain_block { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_gain_block() - Empty argument(s)!"}
     return
  }
  ...
  # Create pins
  create_bd_pin -dir I clk_i
  create_bd_pin -dir I -from 13 -to 0 data_i
  create_bd_pin -dir O -from 13 -to 0 data_o
  create_bd_pin -dir I -from 24 -to 0 gain_i
  create_bd_pin -dir I -from 3 -to 0 log2_gain_i
  ...
  # Create port connections
  connect_bd_net -net axis_red_pitaya_adc_0_adc_clk [get_bd_pins clk_i] [get_bd_pins coarse_gain_and_limi_1/clk_i] [get_bd_pins fine_gain_0/clk_i]
  ...
  connect_bd_net -net gain_i_1 [get_bd_pins gain_i] [get_bd_pins fine_gain_0/gain_i]
  connect_bd_net -net log2_gain_i_1 [get_bd_pins log2_gain_i] [get_bd_pins coarse_gain_and_limi_1/log2_gain_i]
  connect_bd_net -net mux_2x1_0_out_o [get_bd_pins data_i] [get_bd_pins fine_gain_0/data_i]
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins rst_ni] [get_bd_pins coarse_gain_and_limi_1/rst_ni] [get_bd_pins fine_gain_0/rst_ni]
...
proc create_hier_cell_dual_sum_block { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 1 -to 0 log2_gain_i1
  create_bd_pin -dir I rst_ni
  create_bd_pin -dir O -from 13 -to 0 sum_0
  create_bd_pin -dir O -from 13 -to 0 sum_1
  ...
  # Create port connections
  connect_bd_net -net add_select0_i_1 [get_bd_pins add_select0_i] [get_bd_pins conditional_adder_8x2_0/add_select0_i]
  connect_bd_net -net add_select1_i_1 [get_bd_pins add_select1_i] [get_bd_pins conditional_adder_8x2_0/add_select1_i]
  connect_bd_net -net axis_red_pitaya_adc_0_adc_clk [get_bd_pins clk_i] [get_bd_pins coarse_gain_and_limi_2/clk_i] [get_bd_pins coarse_gain_and_limi_3/clk_i] [get_bd_pins conditional_adder_8x2_0/clk_i]
  connect_bd_net -net coarse_gain_and_limi_2_data_o [get_bd_pins sum_0] [get_bd_pins coarse_gain_and_limi_2/data_o]
  connect_bd_net -net coarse_gain_and_limi_3_data_o [get_bd_pins sum_1] [get_bd_pins coarse_gain_and_limi_3/data_o]
  ...
  connect_bd_net -net data0_i_1 [get_bd_pins data0_i] [get_bd_pins conditional_adder_8x2_0/data0_i]
  connect_bd_net -net data1_i_1 [get_bd_pins data1_i] [get_bd_pins conditional_adder_8x2_0/data1_i]
  connect_bd_net -net data2_i_1 [get_bd_pins data2_i] [get_bd_pins conditional_adder_8x2_0/data2_i]
  connect_bd_net -net data3_i_1 [get_bd_pins data3_i] [get_bd_pins conditional_adder_8x2_0/data3_i]
  connect_bd_net -net data4_i_1 [get_bd_pins data4_i] [get_bd_pins conditional_adder_8x2_0/data4_i]
  connect_bd_net -net data5_i_1 [get_bd_pins data5_i] [get_bd_pins conditional_adder_8x2_0/data5_i]
  connect_bd_net -net data6_i_1 [get_bd_pins data6_i] [get_bd_pins conditional_adder_8x2_0/data6_i]
  connect_bd_net -net data7_i_1 [get_bd_pins data7_i] [get_bd_pins conditional_adder_8x2_0/data7_i]
  connect_bd_net -net log2_gain_i1_1 [get_bd_pins log2_gain_i1] [get_bd_pins coarse_gain_and_limi_3/log2_gain_i]
  connect_bd_net -net log2_gain_i_1 [get_bd_pins log2_gain_i] [get_bd_pins coarse_gain_and_limi_2/log2_gain_i]
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins rst_ni] [get_bd_pins coarse_gain_and_limi_2/rst_ni] [get_bd_pins coarse_gain_and_limi_3/rst_ni] [get_bd_pins conditional_adder_8x2_0/rst_ni]
...
0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#USB Reset#GPIO#I2C 0#I2C 0#GPIO#GPIO}\
  ...
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_125M/peripheral_aresetn]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: gain_block
  create_hier_cell_gain_block [current_bd_instance .] gain_block
  ...
  connect_bd_net -net add_select0_i_1 [get_bd_pins dual_sum_block/add_select0_i] [get_bd_pins multi_GPIO_0/data3_o]
  connect_bd_net -net add_select1_i_1 [get_bd_pins dual_sum_block/add_select1_i] [get_bd_pins multi_GPIO_0/data4_o]
  connect_bd_net -net axis_red_pitaya_adc_0_adc_clk [get_bd_pins dac_mux/clk_in1] [get_bd_pins dual_sum_block/clk_i] [get_bd_pins gain_block/clk_i] [get_bd_pins multi_GPIO_0/clk_i] [get_bd_pins mux_2x1_0/clk_i] [get_bd_pins red_pitaya_adc_0/adc_clk]
  ...
  connect_bd_net -net data2_i_1 [get_bd_pins dual_sum_block/data2_i] [get_bd_pins gain_block/data_o]
  connect_bd_net -net dual_sum_block_sum_0 [get_bd_pins dac_mux/in2_i] [get_bd_pins dual_sum_block/sum_0]
  connect_bd_net -net dual_sum_block_sum_1 [get_bd_pins dac_mux/in3_i] [get_bd_pins dual_sum_block/sum_1]
  connect_bd_net -net gain_i_1 [get_bd_pins gain_block/gain_i] [get_bd_pins multi_GPIO_0/data7_o]
  connect_bd_net -net gpio7_i_1 [get_bd_ports gpio6_o] [get_bd_ports gpio7_i]
  connect_bd_net -net log2_gain_i1_1 [get_bd_pins dual_sum_block/log2_gain_i1] [get_bd_pins multi_GPIO_0/data6_o]
  connect_bd_net -net log2_gain_i_1 [get_bd_pins dual_sum_block/log2_gain_i] [get_bd_pins multi_GPIO_0/data5_o]
  connect_bd_net -net log2_gain_i_2 [get_bd_pins gain_block/log2_gain_i] [get_bd_pins multi_GPIO_0/data0_o1]
  connect_bd_net -net multi_GPIO_0_data0_o [get_bd_pins multi_GPIO_0/data0_o] [get_bd_pins mux_2x1_0/sel_i]
  connect_bd_net -net mux_2x1_0_out_o [get_bd_pins gain_block/data_i] [get_bd_pins mux_2x1_0/out_o]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PS7/FCLK_CLK0] [get_bd_pins multi_GPIO_0/s_axi_aclk]
  connect_bd_net -net red_pitaya_adc_0_adc_csn [get_bd_ports adc_csn_o] [get_bd_pins red_pitaya_adc_0/adc_csn]
  connect_bd_net -net red_pitaya_adc_0_adc_dat_a_o [get_bd_pins dac_mux/in0_1] [get_bd_pins dual_sum_block/data0_i] [get_bd_pins mux_2x1_0/in0_i] [get_bd_pins red_pitaya_adc_0/adc_dat_a_o]
  connect_bd_net -net red_pitaya_adc_0_adc_dat_b_o [get_bd_pins dac_mux/in1_i] [get_bd_pins dual_sum_block/data1_i] [get_bd_pins mux_2x1_0/in1_i] [get_bd_pins red_pitaya_adc_0/adc_dat_b_o]
  ...
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins PS7/S00_ARESETN] [get_bd_pins dac_mux/rst_ni] [get_bd_pins dual_sum_block/rst_ni] [get_bd_pins gain_block/rst_ni] [get_bd_pins multi_GPIO_0/s_axi_aresetn] [get_bd_pins mux_2x1_0/rst_ni]
  connect_bd_net -net select0_i_1 [get_bd_pins dac_mux/select0_i] [get_bd_pins multi_GPIO_0/data1_o]
  connect_bd_net -net select1_i_1 [get_bd_pins dac_mux/select1_i] [get_bd_pins multi_GPIO_0/data2_o]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins dac_mux/in4_i] [get_bd_pins dac_mux/in5_i] [get_bd_pins dac_mux/in6_i] [get_bd_pins dac_mux/in7_i] [get_bd_pins dual_sum_block/data3_i] [get_bd_pins dual_sum_block/data4_i] [get_bd_pins dual_sum_block/data5_i] [get_bd_pins dual_sum_block/data6_i] [get_bd_pins dual_sum_block/data7_i] [get_bd_pins xlconstant_0/dout]
